...
iOS-клон Flappy Bird, написанный на Swift с использованием SpriteKit. Проект создан как учебный (pet project) — полная реализация игровой механики с процедурной графикой, физикой и анимациями персонажа.

---

## Статус проекта

**Pet project / учебный** — проект в активной разработке, не предназначен для публикации в App Store. Код намеренно сосредоточен в одном файле (`GameScene.swift`) ради простоты и скорости итераций.
...
| Минимальная платформа | iOS 26.5 (iPhone и iPad) — текущий Deployment Target; при необходимости можно снизить в настройках проекта |
...
- Добавить прогрессию сложности — постепенно увеличивать скорость труб и сужать зазор
- Добавить звуковые эффекты (прыжок, прохождение трубы, game over)
- Экран с таблицей рекордов
- Вынести игровые константы (физика, сложность) в отдельный конфигурационный файл
